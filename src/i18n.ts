  ...
  nl: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Welke apparaten en apps worden ondersteund?', a: '8K IPTV werkt op vrijwel elk apparaat: Smart-TV\'s (Samsung, LG, Sony, Philips), Android-boxen, Amazon Fire TV Stick, Apple TV, iPad, iPhone, MAG-boxen, Formuler en apps zoals IPTV Smarters, Tivimate, GSE.' },

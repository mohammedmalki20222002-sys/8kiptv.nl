...
export const translations: Record<LangCode, T> = {
    ...
    hero: {
      ...
      stat1v: '69K', stat1l: 'Kanavaa',
      stat2v: '220K', stat2l: 'VOD',
    ...
    pricing: {
      ...
      popular: 'Suosituin',
      cta: 'Osta nyt',
      waMsg: (m, d, p) => `Hei, haluan tilata 8K IPTV -paketin: ${m} kuukautta / ${d === 1 ? '1 Laite' : '2 Laitetta'} / ${p} EUR`,
      trust: [
    ...
    footer: {
      ...
      copyright: 'Copyright © 2026 8K IPTV. Kaikki oikeudet pidätetään.',
      sub1: 'Tilaukset',
      sub2: 'Sisältö & Tuki',
      ...
      legal: '8K IPTV toimii täysin itsenäisesti. Kaikki mainitut tavaramerkit, tuotenimet ja kanavasymbolit ovat niiden omistajien omaisuutta. Kaikki maksut ovat SSL-salattuja.',
  ...
  en: {
    ...
    pricing: {
      ...
      waMsg: (m, d, p) => `Hello, I would like to order the 8K IPTV plan: ${m} months / ${d === 1 ? '1 Device' : '2 Devices'} / ${p} EUR`,
      trust: [
    ...
    testimonials: {
      ...
      desc: 'From Spain to Germany, France to Italy — thousands of European customers have replaced their cable subscription with 8K IPTV\'s premium streaming service.',
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'What devices and apps are supported?', a: '8K IPTV works on virtually any device: Smart TVs (Samsung, LG, Sony, Philips), Android boxes, Amazon Fire TV Stick, Apple TV, iPad, iPhone, MAG boxes, Formuler and apps like IPTV Smarters, Tivimate, GSE and standard M3U playlists.' },
    ...
    footer: {
      tagline: 'Premium IPTV for all of Europe. 69.000+ channels, 220.000+ VOD titles, zero contracts and first-class server infrastructure.',
      copyright: 'Copyright © 2026 8K IPTV. All rights reserved.',
      sub1: 'Subscriptions',
      ...
      legal: '8K IPTV operates completely independently. All brand names, product names and channel logos mentioned are the property of their respective owners. All payments are fully SSL-encrypted.',
  ...
  fr: {
    ...
    pricing: {
      ...
      waMsg: (m, d, p) => `Bonjour, je souhaite commander le forfait 8K IPTV : ${m} mois / ${d === 1 ? '1 appareil' : '2 appareils'} / ${p} EUR`,
      trust: [
    ...
    footer: {
      ...
      copyright: 'Copyright © 2026 8K IPTV. Tous droits réservés.',
      sub1: 'Abonnements',
      ...
      legal: '8K IPTV opère de manière totalement indépendante. Toutes les marques, noms de produits et logos mentionnés sont la propriété de leurs détenteurs respectifs. Tous les paiements sont entièrement chiffrés SSL.',
  ...
  da: {
    ...
    pricing: {
      ...
      cta: 'Køb nu',
      waMsg: (m, d, p) => `Hej, jeg vil gerne bestille 8K IPTV-pakken: ${m} måneder / ${d === 1 ? '1 enhed' : '2 enheder'} / ${p} EUR`,
      trust: [
    ...
    footer: {
      ...
      copyright: 'Copyright © 2026 8K IPTV. Alle rettigheder forbeholdes.',
      sub1: 'Abonnementer',
      ...
      legal: '8K IPTV drives fuldstændig uafhængigt. Alle nævnte varemærker, produktnavne og kanallogoer er ejendom af deres respektive ejere. Alle betalinger er fuldt SSL-krypterede.',
  ...
  de: {
    ...
    pricing: {
      ...
      waMsg: (m, d, p) => `Hallo, ich möchte den 8K IPTV-Plan bestellen: ${m} Monate / ${d === 1 ? '1 Gerät' : '2 Geräte'} / ${p} EUR`,
      trust: [
    ...
    testimonials: {
      ...
      desc: 'Von Spanien bis Deutschland, Frankreich bis Italien — Tausende europäische Kunden haben ihr Kabelabo durch 8K IPTV ersetzt.',
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Welche Geräte und Apps werden unterstützt?', a: '8K IPTV läuft auf nahezu jedem Gerät: Smart-TVs (Samsung, LG, Sony, Philips), Android-Boxen, Amazon Fire TV Stick, Apple TV, iPad, iPhone, MAG-Boxen, Formuler und Apps wie IPTV Smarters, Tivimate, GSE.' },
    ...
    footer: {
      tagline: 'Premium IPTV für ganz Europa. 69.000+ Kanäle, 220.000+ VOD-Titel, keine Verträge.',
      copyright: 'Copyright © 2026 8K IPTV. Alle Rechte vorbehalten.',
      ...
      legal: '8K IPTV agiert völlig unabhängig. Alle genannten Markennamen sind Eigentum ihrer jeweiligen Inhaber. Alle Zahlungen sind SSL-verschlüsselt.',
  ...
  es: {
    ...
    pricing: {
      ...
      waMsg: (m, d, p) => `Hola, quiero contratar el plan 8K IPTV: ${m} meses / ${d === 1 ? '1 dispositivo' : '2 dispositivos'} / ${p} EUR`,
      trust: [
    ...
    testimonials: {
      ...
      desc: 'Desde España hasta Alemania, Francia hasta Italia — miles de clientes han reemplazado su suscripción de cable con 8K IPTV.',
    ...
    faq: {
      ...
      items: [
        ...
        { q: '¿Qué dispositivos y apps son compatibles?', a: '8K IPTV funciona en prácticamente cualquier dispositivo: Smart TVs (Samsung, LG, Sony, Philips), cajas Android, Amazon Fire TV Stick, Apple TV, iPad, iPhone, cajas MAG, Formuler y apps como IPTV Smarters, Tivimate, GSE.' },
    ...
    footer: {
      tagline: 'IPTV Premium para toda Europa. 69.000+ canales, 220.000+ títulos VOD, sin contratos.',
      copyright: 'Copyright © 2026 8K IPTV. Todos los derechos reservados.',
      ...
      legal: '8K IPTV opera de forma completamente independiente. Todas las marcas y logos mencionados son propiedad de sus respectivos propietarios. Todos los pagos están cifrados con SSL.',
  ...
  it: {
    ...
    pricing: {
      ...
      waMsg: (m, d, p) => `Ciao, vorrei ordinare il piano 8K IPTV: ${m} mesi / ${d === 1 ? '1 dispositivo' : '2 dispositivi'} / ${p} EUR`,
      trust: [
    ...
    testimonials: {
      ...
      desc: 'Dalla Spagna alla Germania, dalla Francia all\'Italia — migliaia di clienti hanno sostituito il cavo con 8K IPTV.',
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Quali dispositivi e app sono supportati?', a: '8K IPTV funziona su quasi qualsiasi dispositivo: Smart TV (Samsung, LG, Sony, Philips), box Android, Amazon Fire TV Stick, Apple TV, iPad, iPhone, MAG box, Formuler e app come IPTV Smarters, Tivimate, GSE.' },
    ...
    footer: {
      tagline: 'IPTV Premium per tutta Europa. 69.000+ canali, 220.000+ titoli VOD, zero contratti.',
      copyright: 'Copyright © 2026 8K IPTV. Tutti i diritti riservati.',
      ...
      legal: '8K IPTV opera in modo completamente indipendente. Tutti i marchi e logo menzionati sono di proprietà dei rispettivi proprietari. Tutti i pagamenti sono crittografati con SSL.',
  ...
  nl: {
    hero: {
      subtitle: '#1 Premium IPTV in Nederland',
      headline1: 'Ultra 8K Kwaliteit,',
      headline2: 'Bekijk de ',
      highlight: 'UEFA Champions League',
      end: 'Nu live!',
      stat1v: '69K', stat1l: 'Zenders',
      stat2v: '220K', stat2l: 'VOD',
      stat3v: '4K/8K', stat3l: 'Ultra HD',
    ...
    pricing: {
      ...
      heading: 'Kies jouw',
      highlight: 'Premium Plan.',
      desc: 'Geen automatische verlenging. Geen contracten. Veilig, snel en direct beschikbaar in heel Nederland.',
      device1: 'Apparaat',
      device2: 'Apparaten',
      month1: 'Maand',
      monthMany: 'Maanden',
      ...
      cta: 'Nu bestellen',
      waMsg: (m, d, p) => `Hallo, ik wil het 8K IPTV-plan bestellen: ${m} maanden / ${d === 1 ? '1 apparaat' : '2 apparaten'} / ${p} EUR`,
      trust: [
        '15 dagen garantie', 'Geld terug als het abonnement niet werkt.',
        'Directe activering', 'Inloggegevens binnen enkele minuten.',
        'Support 24/7', 'Directe hulp, elke dag van de week.',
      ],
    },
    testimonials: {
      subtitle: 'Klantbeoordelingen',
      heading: 'Vertrouwd door',
      italic: '45.000+ kijkers in Nederland en Europa.',
      desc: 'Van Amsterdam tot Groningen, van Rotterdam tot Maastricht — duizenden Nederlandse huishoudens hebben hun dure kabelabonnement vervangen door 8K IPTV.',
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Welke apparaten en apps worden ondersteund?', a: '8K IPTV werkt op vrijwel elk apparaat: Smart-TV\'s (Samsung, LG, Sony, Philips), Android-boxen, Amazon Fire TV Stick, Apple TV, iPad, iPhone, MAG-boxen, Formuler en apps zoals IPTV Smarters, Tivimate, GSE — met streaming in 4K en 8K waar bron en apparaat dit ondersteunen.' },
        { q: 'Hoe snel moet mijn internetverbinding zijn?', a: 'Voor SD minimaal 8 Mbit/s. Voor Full HD een stabiele 15 Mbit/s, voor 4K streaming 20 Mbit/s en voor 8K UHD 25 Mbit/s of meer.' },
    ...
    footer: {
      tagline: 'Premium IPTV voor heel Nederland. 69.000+ zenders, 220.000+ VOD-titels, geen contracten.',
      copyright: 'Copyright © 2026 8K IPTV. Alle rechten voorbehouden.',
      ...
      legal: '8K IPTV opereert volledig onafhankelijk. Alle genoemde merknamen zijn eigendom van hun respectieve eigenaars. Alle betalingen zijn volledig SSL-versleuteld.',
  ...
  sv: {
    ...
    pricing: {
      ...
      waMsg: (m, d, p) => `Hej, jag vill beställa 8K IPTV-planen: ${m} månader / ${d === 1 ? '1 enhet' : '2 enheter'} / ${p} EUR`,
      trust: [
    ...
    testimonials: {
      ...
      desc: 'Från Spanien till Tyskland, Frankrike till Italien — tusentals kunder har ersatt sin kabel-TV med 8K IPTV.',
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Vilka enheter och appar stöds?', a: '8K IPTV fungerar på nästan vilken enhet som helst: Smart-TV (Samsung, LG, Sony, Philips), Android-boxar, Amazon Fire TV Stick, Apple TV, iPad, iPhone, MAG-boxar, Formuler och appar som IPTV Smarters, Tivimate, GSE.' },
    ...
    footer: {
      ...
      copyright: 'Copyright © 2026 8K IPTV. Alla rättigheter förbehållna.',
      ...
      legal: '8K IPTV verkar helt oberoende. Alla nämnda varumärken är ägs av sina respektive ägare. Alla betalningar är helt SSL-krypterade.',
  ...
  no: {
    ...
    pricing: {
      ...
      waMsg: (m, d, p) => `Hei, jeg vil bestille 8K IPTV-planen: ${m} måneder / ${d === 1 ? '1 enhet' : '2 enheter'} / ${p} EUR`,
      trust: [
    ...
    testimonials: {
      ...
      desc: 'Fra Spania til Tyskland, Frankrike til Italia — tusenvis av kunder har erstattet kabelabonnementet med 8K IPTV.',
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Hvilke enheter og apper støttes?', a: '8K IPTV fungerer på nesten enhver enhet: Smart-TV (Samsung, LG, Sony, Philips), Android-bokser, Amazon Fire TV Stick, Apple TV, iPad, iPhone, MAG-bokser, Formuler og apper som IPTV Smarters, Tivimate, GSE.' },
    ...
    footer: {
      ...
      copyright: 'Copyright © 2026 8K IPTV. Alle rettigheter forbeholdt.',
      ...
      legal: '8K IPTV opererer helt uavhengig. Alle nevnte varemerker er eiendom av sine respektive eiere. Alle betalinger er fullt SSL-kryptert.',
  ...
  pl: {
    ...
    pricing: {
      ...
      waMsg: (m, d, p) => `Cześć, chcę zamówić plan 8K IPTV: ${m} miesięcy / ${d === 1 ? '1 urządzenie' : '2 urządzenia'} / ${p} EUR`,
      trust: [
    ...
    testimonials: {
      ...
      desc: 'Od Hiszpanii po Niemcy, od Francji po Włochy — tysiące klientów zastąpiło kablówkę usługą 8K IPTV.',
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Jakie urządzenia i aplikacje są obsługiwane?', a: '8K IPTV działa na praktycznie każdym urządzeniu: Smart TV (Samsung, LG, Sony, Philips), dekodery Android, Amazon Fire TV Stick, Apple TV, iPad, iPhone, dekodery MAG, Formuler i aplikacje jak IPTV Smarters, Tivimate, GSE.' },
    ...
    footer: {
      ...
      copyright: 'Copyright © 2026 8K IPTV. Wszelkie prawa zastrzeżone.',
      ...
      legal: '8K IPTV działa całkowicie niezależnie. Wszystkie wymienione znaki towarowe są własnością ich właścicieli. Wszystkie płatności są szyfrowane SSL.',
  ...
  pt: {
    ...
    pricing: {
      ...
      waMsg: (m, d, p) => `Olá, gostaria de encomendar o plano 8K IPTV: ${m} meses / ${d === 1 ? '1 dispositivo' : '2 dispositivos'} / ${p} EUR`,
      trust: [
    ...
    testimonials: {
      ...
      desc: 'Da Espanha à Alemanha, da França à Itália — milhares de clientes europeus substituíram a TV por cabo pela 8K IPTV.',
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Que dispositivos e apps são suportados?', a: '8K IPTV funciona em praticamente qualquer dispositivo: Smart TVs (Samsung, LG, Sony, Philips), boxes Android, Amazon Fire TV Stick, Apple TV, iPad, iPhone, MAG boxes, Formuler e apps como IPTV Smarters, Tivimate, GSE.' },
    ...
    footer: {
      tagline: 'IPTV Premium para toda a Europa. 69.000+ canais, 220.000+ títulos VOD, zero contratos.',
      copyright: 'Copyright © 2026 8K IPTV. Todos os direitos reservados.',
      ...
      legal: '8K IPTV opera de forma completamente independente. Todas as marcas e logos mencionados são propriedade dos respetivos proprietários. Todos os pagamentos são encriptados com SSL.',
  ...
  ro: {
    ...
    pricing: {
      ...
      waMsg: (m, d, p) => `Bună, doresc să comand planul 8K IPTV: ${m} luni / ${d === 1 ? '1 dispozitiv' : '2 dispozitive'} / ${p} EUR`,
      trust: [
    ...
    testimonials: {
      ...
      desc: 'Din Spania în Germania, din Franța în Italia — mii de clienți și-au înlocuit abonamentul TV cu 8K IPTV.',
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Ce dispozitive și aplicații sunt suportate?', a: '8K IPTV funcționează pe aproape orice dispozitiv: Smart TV (Samsung, LG, Sony, Philips), boxe Android, Amazon Fire TV Stick, Apple TV, iPad, iPhone, boxe MAG, Formuler și aplicații precum IPTV Smarters, Tivimate, GSE.' },
    ...
    footer: {
      tagline: 'IPTV Premium pentru toată Europa. 69.000+ canale, 220.000+ titluri VOD, fără contracte.',
      copyright: 'Copyright © 2026 8K IPTV. Toate drepturile rezervate.',
      ...
      legal: '8K IPTV operează complet independent. Toate mărcile menționate sunt proprietatea proprietarilor respectivi. Toate plățile sunt criptate SSL.',
  ...
  cs: {
    ...
    pricing: {
      ...
      waMsg: (m, d, p) => `Dobrý den, rád bych objednal plán 8K IPTV: ${m} měsíců / ${d === 1 ? '1 zařízení' : '2 zařízení'} / ${p} EUR`,
      trust: [
    ...
    testimonials: {
      ...
      desc: 'Od Španělska po Německo, od Francie po Itálii — tisíce zákazníků nahradily kabelovou televizi službou 8K IPTV.',
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Jaká zařízení a aplikace jsou podporovány?', a: '8K IPTV funguje prakticky na jakémkoli zařízení: Smart TV (Samsung, LG, Sony, Philips), Android boxy, Amazon Fire TV Stick, Apple TV, iPad, iPhone, MAG boxy, Formuler a aplikace jako IPTV Smarters, Tivimate, GSE.' },
    ...
    footer: {
      ...
      copyright: 'Copyright © 2026 8K IPTV. Všechna práva vyhrazena.',
      ...
      legal: '8K IPTV funguje zcela nezávisle. Všechny zmíněné ochranné známky jsou majetkem příslušných vlastníků. Všechny platby jsou šifrovány SSL.',
  ...
  tr: {
    ...
    pricing: {
      ...
      waMsg: (m, d, p) => `Merhaba, 8K IPTV planını sipariş etmek istiyorum: ${m} ay / ${d === 1 ? '1 cihaz' : '2 cihaz'} / ${p} EUR`,
      trust: [
    ...
    testimonials: {
      ...
      desc: 'İspanya\'dan Almanya\'ya, Fransa\'dan İtalya\'ya — binlerce Avrupalı müşteri kablo aboneliğini 8K IPTV ile değiştirdi.',
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Hangi cihazlar ve uygulamalar destekleniyor?', a: '8K IPTV hemen hemen her cihazda çalışır: Smart TV (Samsung, LG, Sony, Philips), Android kutular, Amazon Fire TV Stick, Apple TV, iPad, iPhone, MAG kutular, Formuler ve IPTV Smarters, Tivimate, GSE gibi uygulamalar.' },
    ...
    footer: {
      tagline: 'Tüm Avrupa için Premium IPTV. 69.000+ kanal, 220.000+ VOD başlığı, sıfır sözleşme.',
      copyright: 'Telif Hakkı © 2026 8K IPTV. Tüm hakları saklıdır.',
      ...
      legal: '8K IPTV tamamen bağımsız olarak faaliyet göstermektedir. Belirtilen tüm marka adları ilgili sahiplerine aittir. Tüm ödemeler tamamen SSL ile şifrelenmektedir.',
  ...
  ar: {
    ...
    pricing: {
      ...
      cta: 'اشترِ الآن',
      waMsg: (m, d, p) => `مرحباً، أريد طلب باقة 8K IPTV: ${m} أشهر / ${d === 1 ? 'جهاز واحد' : 'جهازان'} / ${p} EUR`,
      trust: [
    ...
    footer: {
      ...
      copyright: 'حقوق النشر © 2026 8K IPTV. جميع الحقوق محفوظة.',
      sub1: 'الاشتراكات',
      sub2: 'المحتوى والدعم',
      sub3: 'حالة الخادم',
      ...
      legal: 'تعمل 8K IPTV باستقلالية تامة. جميع العلامات التجارية وأسماء المنتجات وشعارات القنوات المذكورة ملك لأصحابها. جميع المدفوعات مشفرة بالكامل بـ SSL.',
      cert: 'شهادة الأمان',
      sla: 'اتفاقية SLA',
    },
  },

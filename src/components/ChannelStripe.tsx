...
const EU_BROADCAST: Ch[] = [
  // Dutch channels lead the strip — this is a Netherlands-facing site.
  { id: "rtl",       name: "RTL 4",         logo: "/logos/rtl.png",       bg: "#E4001B" },
  { id: "videoland", name: "Videoland",     logo: "/logos/videoland.svg", bg: "#E50000" },
  { id: "espnnl",    name: "ESPN NL",       logo: "/logos/espn.svg",      bg: "#CC0000" },
